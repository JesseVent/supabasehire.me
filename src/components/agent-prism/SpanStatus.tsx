...
const STATUS_COLORS_BADGE: Record<TraceSpanStatus, string> = {
  success: 'bg-agentprism-success-muted text-agentprism-success-muted-foreground',
  error: 'bg-agentprism-error-muted text-agentprism-error-muted-foreground',
  pending: 'bg-agentprism-pending-muted text-agentprism-pending-muted-foreground',
  warning: 'bg-agentprism-warning-muted text-agentprism-warning-muted-foreground',
}
