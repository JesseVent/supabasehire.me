...
export const DetailsViewContentViewer = ({
  ...
  if (!content) {
    return <p className="text-agentprism-muted-foreground p-3 text-sm italic">No data available</p>
  }

  return (
    <div className={`border-agentprism-border relative rounded-lg border ${className}`}>
