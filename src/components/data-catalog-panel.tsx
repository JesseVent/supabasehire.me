...
const DEMO_CATALOG_TABLES: CatalogTable[] = [
  {
    ...
    row_count: 10241,
    ai_description:
      'Core user accounts table. Stores authentication identities, profile metadata, and subscription tier. Referenced by nearly every other table in the schema.',
    profiled_at: '2024-06-15T09:12:00Z',
    ...
    columns: [
      {
        ...
        nullable: false,
        null_pct: 0,
        distinct_count: 10241,
        sample_values: ['a1b2c3d4-...', 'e5f6a7b8-...'],
        min_val: null,
        max_val: null,
        ai_description: 'Primary key. UUID v4 generated by Supabase Auth.',
      },
      {
        id: 'c1-2',
        table_id: 'demo-1',
        ...
        min_val: null,
        max_val: null,
        ai_description: 'Unique email address used for authentication and notifications.',
      },
      {
        id: 'c1-3',
        table_id: 'demo-1',
        ...
        nullable: false,
        null_pct: 0,
        distinct_count: 10198,
        sample_values: ['alice_dev', 'bob42', 'carol_writes'],
        min_val: null,
        max_val: null,
        ai_description: 'Public-facing display name. Unique and immutable after 30 days.',
      },
      {
        id: 'c1-4',
        table_id: 'demo-1',
        ...
        min_val: null,
        max_val: null,
        ai_description: 'Subscription tier. Determines feature access and rate limits.',
      },
      {
        id: 'c1-5',
        table_id: 'demo-1',
        ...
        min_val: '2024-01-15',
        max_val: '2024-06-14',
        ai_description: 'Account creation timestamp.',
      },
      {
        id: 'c1-6',
        table_id: 'demo-1',
        ...
        null_pct: 31.2,
        distinct_count: 7043,
        sample_values: ['https://...', null],
        min_val: null,
        max_val: null,
        ai_description: 'CDN URL for profile avatar. Null for users who have not uploaded a photo.',
      },
    ],
  },
  {
    ...
    row_count: 52847,
    ai_description:
      'User-generated content (blog posts, articles). Supports draft/published workflow with soft-delete via deleted_at. Full-text search index on title + body.',
    profiled_at: '2024-06-15T09:13:00Z',
    created_at: '2024-01-15T00:00:00Z',
    columns: [
      {
        id: 'c2-1',
        ...
        nullable: false,
        null_pct: 0,
        distinct_count: 52847,
        sample_values: [],
        min_val: null,
        max_val: null,
        ai_description: 'Primary key.',
      },
      {
        id: 'c2-2',
        table_id: 'demo-2',
        ...
        min_val: null,
        max_val: null,
        ai_description: 'Author FK → users.id. ~79% of users have at least one post.',
      },
      {
        id: 'c2-3',
        table_id: 'demo-2',
        ...
        nullable: false,
        null_pct: 0,
        distinct_count: 52831,
        sample_values: ['Getting started with Next.js', 'My first post'],
        min_val: null,
        max_val: null,
        ai_description: 'Post headline. Max 255 characters enforced by a check constraint.',
      },
      {
        id: 'c2-4',
        table_id: 'demo-2',
        ...
        null_pct: 0,
        distinct_count: 3,
        sample_values: ['draft', 'published', 'archived'],
        min_val: null,
        max_val: null,
        ai_description: 'Publication state. Only "published" posts are visible to non-authors.',
      },
      {
        id: 'c2-5',
        table_id: 'demo-2',
        ...
        null_pct: 0,
        distinct_count: 4812,
        sample_values: ['0', '42', '1893'],
        min_val: '0',
        max_val: '284931',
        ai_description: 'Lifetime view counter. Incremented by the view-tracking edge function.',
      },
      {
        id: 'c2-6',
        table_id: 'demo-2',
        ...
        min_val: null,
        max_val: null,
        ai_description: 'Soft-delete timestamp. Non-null means the post has been removed.',
      },
    ],
  },
  {
    ...
    row_count: 198432,
    ai_description:
      'Threaded comments on posts. Supports one level of nesting via parent_id self-reference. Moderation status tracked on each row.',
    profiled_at: '2024-06-15T09:14:00Z',
    created_at: '2024-01-15T00:00:00Z',
    columns: [
      {
        id: 'c3-1',
      ...
      },
      {
        ...
        nullable: false,
        null_pct: 0,
        distinct_count: 41207,
        sample_values: [],
        min_val: null,
        max_val: null,
        ai_description: 'Parent post FK → posts.id.',
      },
      {
        id: 'c3-3',
        table_id: 'demo-3',
        ...
        min_val: null,
        max_val: null,
        ai_description: 'Commenter FK → users.id.',
      },
      {
        id: 'c3-4',
        table_id: 'demo-3',
        ...
        nullable: true,
        null_pct: 68.3,
        distinct_count: 63241,
        sample_values: [null],
        min_val: null,
        max_val: null,
        ai_description: 'Self-reference for replies. Null = top-level comment.',
      },
      {
        id: 'c3-5',
        table_id: 'demo-3',
        ...
        nullable: false,
        null_pct: 0,
        distinct_count: 197891,
        sample_values: ['Great article!', 'This helped a lot.'],
        min_val: null,
        max_val: null,
        ai_description: 'Comment text. Markdown supported, sanitized on read.',
      },
      {
        id: 'c3-6',
        table_id: 'demo-3',
        ...
        min_val: null,
        max_val: null,
        ai_description: 'Moderation flag. Flagged comments are hidden pending review.',
      },
    ],
  },
  {
    ...
    row_count: 445213,
    ai_description:
      'Post and comment reactions. Composite unique constraint on (user_id, target_type, target_id) prevents duplicate likes.',
    profiled_at: '2024-06-15T09:14:30Z',
    created_at: '2024-01-15T00:00:00Z',
    columns: [
      {
        id: 'c4-1',
        ...
        nullable: false,
        null_pct: 0,
        distinct_count: 445213,
        sample_values: ['1', '2', '3'],
        min_val: '1',
        max_val: '445213',
        ai_description: 'Auto-increment primary key.',
      },
      {
        id: 'c4-2',
        table_id: 'demo-4',
        ...
        min_val: null,
        max_val: null,
        ai_description: 'Who liked it → users.id.',
      },
      {
        id: 'c4-3',
        table_id: 'demo-4',
        ...
        null_pct: 0,
        distinct_count: 2,
        sample_values: ['post', 'comment'],
        min_val: null,
        max_val: null,
        ai_description: 'Polymorphic type discriminator.',
      },
      {
        id: 'c4-4',
        table_id: 'demo-4',
        ...
        max_val: null,
        ai_description:
          'Polymorphic FK — points to posts.id or comments.id depending on target_type.',
      },
    ],
  },
  {
    ...
    row_count: 42,
    ai_description:
      'Content taxonomy. Static reference table — new categories require a migration. Supports hierarchical nesting via parent_id.',
    profiled_at: '2024-06-15T09:15:00Z',
    created_at: '2024-01-15T00:00:00Z',
    columns: [
      {
        id: 'c5-1',
        ...
        min_val: '1',
        max_val: '42',
        ai_description: 'Sequential primary key.',
      },
      {
        id: 'c5-2',
        table_id: 'demo-5',
        ...
        null_pct: 0,
        distinct_count: 42,
        sample_values: ['Technology', 'Design', 'Business'],
        min_val: null,
        max_val: null,
        ai_description: 'Human-readable category label. Unique.',
      },
      {
        id: 'c5-3',
        table_id: 'demo-5',
        ...
        min_val: null,
        max_val: null,
        ai_description: 'URL-safe slug for routing. Lowercase, hyphen-separated.',
      },
      {
        id: 'c5-4',
        table_id: 'demo-5',
        ...
        null_pct: 57.1,
        distinct_count: 18,
        sample_values: [null, '1', '3'],
        min_val: null,
        max_val: null,
        ai_description: 'Parent category for subcategory nesting. Null = top-level category.',
      },
    ],
  },
  {
    ...
    row_count: 87291,
    ai_description:
      'Many-to-many join table linking posts to categories. Composite PK on (post_id, category_id). A post can belong to up to 5 categories (enforced by trigger).',
    profiled_at: '2024-06-15T09:15:30Z',
    created_at: '2024-01-15T00:00:00Z',
    columns: [
      {
        id: 'c6-1',
      ...
      },
      {
        ...
        min_val: '1',
        max_val: '42',
        ai_description: 'FK → categories.id.',
      },
    ],
  },
  {
    ...
    row_count: 3891042,
    ai_description:
      'Append-only audit trail for all data mutations. Written by a set of database triggers. Partitioned by month. Do not query without a time-range filter — full scans are expensive.',
    profiled_at: '2024-06-15T09:16:00Z',
    created_at: '2024-01-15T00:00:00Z',
    columns: [
      {
        id: 'c7-1',
        ...
        nullable: false,
        null_pct: 0,
        distinct_count: 3891042,
        sample_values: [],
        min_val: '1',
        max_val: '3891042',
        ai_description: 'Sequential ID within partition.',
      },
      {
        id: 'c7-2',
        table_id: 'demo-7',
        ...
        null_pct: 0,
        distinct_count: 7,
        sample_values: ['users', 'posts', 'comments'],
        min_val: null,
        max_val: null,
        ai_description: 'Name of the table that was mutated.',
      },
      {
        id: 'c7-3',
        table_id: 'demo-7',
        ...
        null_pct: 0,
        distinct_count: 3,
        sample_values: ['INSERT', 'UPDATE', 'DELETE'],
        min_val: null,
        max_val: null,
        ai_description: 'DML operation type.',
      },
      {
        id: 'c7-4',
        table_id: 'demo-7',
        ...
        null_pct: 41.2,
        distinct_count: null,
        sample_values: [null, '{"status":"draft"}'],
        min_val: null,
        max_val: null,
        ai_description: 'Row state before the change. Null for INSERT operations.',
      },
      {
        id: 'c7-5',
        table_id: 'demo-7',
        ...
        null_pct: 8.7,
        distinct_count: null,
        sample_values: ['{"status":"published"}', null],
        min_val: null,
        max_val: null,
        ai_description: 'Row state after the change. Null for DELETE operations.',
      },
      {
        id: 'c7-6',
        table_id: 'demo-7',
        ...
        min_val: '2024-01-15',
        max_val: '2024-06-15',
        ai_description: 'Timestamp of the mutation. Partition key.',
      },
    ],
  },
  {
    ...
    row_count: 124876,
    ai_description:
      'In-app notification queue. Consumed by the notification-dispatcher edge function. Read receipts tracked via read_at.',
    profiled_at: '2024-06-15T09:16:30Z',
    created_at: '2024-01-15T00:00:00Z',
    columns: [
      {
        id: 'c8-1',
      ...
      },
      {
        ...
        min_val: null,
        max_val: null,
        ai_description: 'Recipient FK → users.id.',
      },
      {
        id: 'c8-3',
        table_id: 'demo-8',
        ...
        null_pct: 0,
        distinct_count: 6,
        sample_values: ['new_comment', 'new_like', 'mention', 'follow'],
        min_val: null,
        max_val: null,
        ai_description: 'Event type. Determines notification message template and routing.',
      },
      {
        id: 'c8-4',
        table_id: 'demo-8',
        ...
        null_pct: 0,
        distinct_count: null,
        sample_values: ['{"post_id":"...","actor":"alice"}'],
        min_val: null,
        max_val: null,
        ai_description: 'Event-specific payload. Schema varies by type.',
      },
      {
        id: 'c8-5',
        table_id: 'demo-8',
        ...
        nullable: true,
        null_pct: 62.4,
        distinct_count: 47123,
        sample_values: [null, '2024-06-10T14:22:00Z'],
        min_val: null,
        max_val: null,
        ai_description: 'When the user opened the notification. Null = unread.',
      },
    ],
  },
]
    ...
    <div className="border rounded-md bg-card group">
      ...
      <div className="flex items-center gap-3 px-3 py-2.5 hover:bg-muted/30 transition-colors">
        ...
        <div className="flex items-center gap-2 min-w-0 flex-1">
          <Badge
            variant="outline"
            className="text-[10px] font-mono px-1 py-0 h-4 shrink-0 hidden sm:inline-flex"
          >
            {table.schema_name}
          </Badge>
        ...
        <div className="flex items-center gap-3 text-[11px] text-muted-foreground shrink-0">
          ...
          {profiledAgo && <span className="hidden lg:block">{profiledAgo}</span>}
          {cols.length > 0 && <span className="hidden sm:block">{cols.length} cols</span>}
        </div>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => onReProfile(table.table_name)}
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => onGenerateAI(table)}
                  disabled={isGenerating || !table.profiled_at}
                  className="h-6 w-6 p-0"
                >
                  {isGenerating ? (
                    <Loader2 className="size-3 animate-spin" />
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  disabled={isCommitting || !table.ai_description}
                  className="h-6 w-6 p-0"
                >
                  {isCommitting ? (
                    <Loader2 className="size-3 animate-spin" />
              ...
              <TooltipContent>
                {table.ai_description ? 'Commit to schema' : 'Generate AI first'}
              </TooltipContent>
            </Tooltip>
          </div>
        </TooltipProvider>
...
export function DataCatalogPanel({
  ...
  const handleGenerateAll = async () => {
    ...
    toast.success(
      `AI generation complete: ${success} succeeded${failed > 0 ? `, ${failed} failed` : ''}`
    )
    await loadCatalog()
    ...
    if (search.trim()) {
      ...
      result = result.filter(
        (t) =>
          ...
          t.columns?.some(
            (c) =>
              c.column_name.toLowerCase().includes(q) || c.ai_description?.toLowerCase().includes(q)
          )
      )
    }
      ...
      <Card className="mt-6">
        <CardContent className="py-16 flex flex-col items-center justify-center text-center gap-3">
          ...
          <p className="text-sm text-muted-foreground">
            Connect to a Supabase project to use the Data Catalog.
          </p>
        </CardContent>
      </Card>
    )
      ...
      <div className="mt-6 max-w-lg mx-auto">
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              The catalog requires two tables in your Supabase project:{' '}
              <code className="font-mono text-xs bg-muted px-1 py-0.5 rounded">catalog_tables</code>{' '}
              and{' '}
            ...
            <div className="rounded-md border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/30 px-3 py-2.5 text-xs text-amber-800 dark:text-amber-300">
              Also deploy the <code className="font-mono">catalog-generator</code> edge function and
              set <code className="font-mono">OPENAI_API_KEY</code> as a Supabase secret for AI
              descriptions.
            </div>
    ...
    <div className="space-y-4 mt-4">
      ...
      {isDemoMode && (
        <div className="flex items-center gap-2 px-3 py-2 rounded-md bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 text-xs text-amber-800 dark:text-amber-300">
          ...
          Demo Mode — sample catalog data. Connect to a real project to profile your own tables and
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            onClick={
              isDemoMode
                ? () => toast.info('Connect to a real project to profile tables')
                : handleProfileAll
            }
          ...
          <Button
            ...
            onClick={
              isDemoMode
                ? () => toast.info('Connect to a real project to generate AI descriptions')
                : handleGenerateAll
            }
      ...
      <div className="flex items-center gap-4 text-xs text-muted-foreground border-b pb-2">
        ...
        <span className="flex items-center gap-1.5">
          ...
          <strong className="text-foreground">{profiledCount}</strong> profiled
        </span>
        <span className="flex items-center gap-1.5">
          <Sparkles className="size-3" />
          <strong className="text-foreground">{aiCount}</strong> with AI
        </span>
      </div>
          ...
          <CardContent className="py-12 flex flex-col items-center justify-center text-center gap-3">
            ...
            {tables.length === 0 ? (
              <>
                ...
                <p className="text-sm text-muted-foreground">
                  Click "Profile All" to scan your database.
                </p>
              </>
            ) : (
              <>
          ...
          <div className="space-y-2 pr-1">
            {filteredTables.map((table) => (
              <TableCard
                ...
                onReProfile={
                  isDemoMode
                    ? (_t: string) => toast.info('Connect to a real project to re-profile')
                    : handleReProfile
                }
                onGenerateAI={
                  isDemoMode
                ...
                onCommit={
                  isDemoMode
                    ? (_t: CatalogTable) =>
                        toast.info('Connect to a real project to commit descriptions')
                    : handleCommit
                }
