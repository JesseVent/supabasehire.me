// NOTE: there is intentionally no Management API helper here. DCR-issued OAuth
// tokens are only valid for mcp.supabase.com — api.supabase.com/v1 rejects them
// with 401. All SQL/introspection goes through SupabaseMcpClient instead.
